...
const educationList: EducationItem[] = [
  {
    ...
    dates: "2022 – 2026",
    grade: "7.6 CGPA",
    description: "Currently pursuing my Bachelor's degree with specialization in AIML. Focused on full stack development and real-world problem-solving.",
  },
  {
    institution: "R.J.S College, Dighwara(Saran)",
  ...
  {
    institution: "S.S.Academy AMi, Saran",
